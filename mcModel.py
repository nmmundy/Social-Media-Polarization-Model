...
class MarkovChainPolarizationModel:
    def __init__(self, n, eta=2.0, zPrime=1., gamma=.5, zeta=5, sigma=0.1, seed=None):
        self.n = n # number of nodes
        self.eta = eta # sensitivity to opinion updates parameter
        self.sigma = sigma # standard deviation for edge weights
        self.gamma = gamma #
        self.zPrime = zPrime # target opinion between 0,1
        self.zeta = zeta #
...
def visualization(opinions, weights, interval=500):
    ...
    def update(frame):
        ...
        for i in range(n):
            ...
            #print("All weights of graph ", curr_weights_matrix)
